...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--docker", action="store_true", help="Use docker to start nodes")
    parser.add_argument("-r", "--remote", action="store_true", help="Start nodes on remote machines")
    parser.add_argument("-s", "--separate", action="store_true", help="Start nodes in separate terminals")
    parser.add_argument("-p", "--port", type=int, default=8080, help="Port to start introducer on")
